...
def test_get_latest_quote_userid_input_output_none():
    ...
    id = get_latest_quote_in_past_7_days(user_id="12345")
...
def test_get_latest_quote_tweetId_input_output_none():
    ...
    id = get_latest_quote_in_past_7_days(tweet_id="12345")
...
def test_get_latest_quote_empty_inputs_output_none():
    ...
    try:
        _ = get_latest_quote_in_past_7_days(user_id=None, tweet_id=None)
...
def test_get_latest_quote_userid_input():
    ...
    id = get_latest_quote_in_past_7_days(user_id="989898")
...
def test_get_latest_quote_tweetid_input():
    ...
    id = get_latest_quote_in_past_7_days(tweet_id="1111")
